...
_gulp2.default.task('run-tests', function () {
  _gulp2.default.src(['./tests/inverted-index-test.js']).pipe((0, _gulpBabel2.default)()).pipe((0, _gulpInjectModules2.default)()).pipe((0, _gulpJasmineNode2.default)());
  // pipe(exit());
});
